...
@synthesize subscriptionExpireDate;
...
- (NSDictionary *)toDictionary {
    //   NSLog(@"todictionary");
    return NSDictionaryOfVariableBindings(subscriptionProductId, subscriptionTransctionId, subscriptionReceiptData, subscriptionAmount, subscriptionExpireDate);
}

- (void)fromDictionary:(NSDictionary *)dictionary {
    NSArray *array=[NSArray arrayWithObjects:@"id", @"subscriptionProductId", @"subscriptionTransctionId", @"subscriptionReceiptData", @"subscriptionAmount", @"subscriptionExpireDate", nil];
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    [subscriptionInfo setSubscriptionExpireDate:subscriptionExpireDate];
