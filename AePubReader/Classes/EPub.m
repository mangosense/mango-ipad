...
NSString* manifestFilePath = [NSString stringWithFormat:@"%@/%d/META-INF/container.xml", [self applicationDocumentsDirectory],iden];
...
//		NSLog(@"%@", [NSString stringWithFormat:@"%@/UnzippedEpub/%@", [self applicationDocumentsDirectory], [opfPath stringValue]]);
        ...
        return [NSString stringWithFormat:@"%@/%d/%@", [self applicationDocumentsDirectory], iden,[opfPath stringValue]];
	} else {
