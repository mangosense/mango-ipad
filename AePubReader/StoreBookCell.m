...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
            ...
            _bookImageView = [[UIImageView alloc] initWithFrame:CGRectMake(2, 2, 100, 105)];
            _frameImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 102, 107)];
            _bookTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(2, _frameImageView.frame.size.height, 102, 16)];
