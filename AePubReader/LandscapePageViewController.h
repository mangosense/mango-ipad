...
@interface LandscapePageViewController : UIViewController<UIWebViewDelegate,UISearchBarDelegate,UIGestureRecognizerDelegate,TextDelegate,ActionOnDeleteDelegate,TableOfContentDelegate>
